...
- [EveIRC](https://github.com/Inspyre-Technologies/EveIRC) - Extendable chat/channel management/server management/service-providing bot. Using the [Cinch Framework](https://github.com/cinchrb/cinch). `Ruby`
